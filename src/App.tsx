    ...
    <div className="App min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
        ...
        {testResults.length > 0 && (
          ...
          >
            <h3 className="font-semibold text-gray-900 mb-3 text-lg transition-colors duration-200">
              Test Results:
            </h3>
        ...
        <div
          className="mt-12 bg-white border border-gray-200 rounded-lg p-6 shadow-sm
                       transition-all duration-300 ease-out hover:shadow-md hover:scale-[1.01]"
        >
          <h3 className="font-semibold text-gray-900 mb-4 text-lg transition-colors duration-200">
            Test Scenarios:
          </h3>
